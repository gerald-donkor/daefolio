...
test('mouse movement wipes without holding and never auto-completes', async ({ page }) => {
  ...
  // Cover well beyond the old 58% completion threshold. Hover wiping must
  // leave the remaining veil intact instead of fading the whole canvas.
...
test('the portrait owns touch gestures without disabling page scroll elsewhere', async ({ page }) => {
